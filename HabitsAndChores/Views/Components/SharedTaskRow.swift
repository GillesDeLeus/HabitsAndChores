...
/// A row for a shared household chore (recurring), shown in the Today list alongside
/// private tasks. Carries a small house badge, the household name, assignees, and a
/// completion toggle. Pass `onTap` to open the editor when the label area is tapped.
